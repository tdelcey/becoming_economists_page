...
The database is available in `.csv` format and can be downloaded from its [Zenodo Repository](../../../../data/french/). Comprehensive documentation can be accessed [here](../../../../documentation/french/).
